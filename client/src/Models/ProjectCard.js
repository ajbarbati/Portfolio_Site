              ...
              <div key={key} className="projectCard">
                ...
                <div className="projectLinks">
                  <a className="projectLink A" href={project.URL}>
                    <img className="pGitLink" alt="github" src="https://res.cloudinary.com/dz3p8xcr8/image/upload/v1594343230/Portfolio/github-1_nqhu66.png"></img>
                  </a>
                  <a className="projectLink B" href={project.URL}>
                    <img className="pHostLink" alt="hosted project" src="https://res.cloudinary.com/dz3p8xcr8/image/upload/v1594343347/Portfolio/Icon_awesome-link_qwksft.png"></img>
                  </a>
                </div>
